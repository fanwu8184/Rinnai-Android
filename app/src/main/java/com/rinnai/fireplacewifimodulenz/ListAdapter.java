...
public class ListAdapter extends ArrayAdapter<String> {
    ...
    public ListAdapter(Context context, List<String> objects) {
        super(context, R.layout.scrollview_row_rinnai33a_timers, objects);
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            convertView = mInflater.inflate(R.layout.scrollview_row_rinnai33a_timers, parent, false);

            holder = new ViewHolder();
            holder.timerrowLayout = convertView.findViewById(R.id.timerrow_layout);
